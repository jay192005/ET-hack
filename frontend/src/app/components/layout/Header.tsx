...
export function Header() {
  ...
  return (
    <header className="h-14 bg-white border-b flex items-center justify-between px-4 lg:px-6 flex-shrink-0 sticky top-0 z-30" style={{ borderColor: "#ffd4b8" }}>
      ...
      <div className="flex items-center gap-2">
        ...
        {pendingCount > 0 && (
          <button
            ...
            className="relative w-9 h-9 rounded-lg flex items-center justify-center text-gray-500 hover:bg-orange-50 transition-colors"
          >
            <Bell size={18} />
            <span
        ...
        {company && (
          <div className="hidden md:flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg text-xs font-semibold" style={{ background: "#fef8f3", color: "#c8102e" }}>
            <Building2 size={12} />
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-2.5 py-1.5 rounded-lg hover:bg-orange-50 transition-colors"
          >
            <div
            ...
            <div className="hidden sm:block text-left">
              ...
              <p className="text-xs capitalize leading-none mt-0.5" style={{ color: "#c8102e" }}>
                {currentUser.role}
              </p>
            </div>
          ...
          {dropdownOpen && (
            <>
              ...
              <div className="absolute right-0 mt-2 w-52 bg-white rounded-xl border shadow-lg z-50 py-1 overflow-hidden" style={{ borderColor: "#ffd4b8" }}>
                <div className="px-4 py-3 border-b" style={{ borderColor: "#ffd4b8" }}>
                  ...
                  <span
                    ...
                    style={{ background: "#fef3ed", color: "#c8102e" }}
                  >
                    {currentUser.role}
                  </span>
                </div>
                ...
                <div className="border-t my-1" style={{ borderColor: "#ffd4b8" }} />
                <button
